...
class AppDelegate: UIResponder, UIApplicationDelegate , UINavigationControllerDelegate{
    ...
    func getlistOfFolders(type : Int)->[Folder]{
        ...
        fetchRequest.predicate = NSPredicate(format: "type = %@", type as NSNumber)
        do{
            names = try managedObjectContext.executeFetchRequest(fetchRequest) as! [Folder];
        }catch{
    ...
    func getListOfSongs(idf : Int, type : Int)->[Song]{
        ...
        fetchRequest.predicate = NSPredicate(format: "idf = %@ AND type = %@", idf as NSNumber, type as NSNumber);
        do{
            songs = try managedObjectContext.executeFetchRequest(fetchRequest) as! [Song];
        }catch{
    ...
    */
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "brownapps.ArtistPad_ios_swift" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ArtistPad_ios_swift", withExtension: "momd")!
